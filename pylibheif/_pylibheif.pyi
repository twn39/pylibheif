...
class HeifContext:
    ...
    def read_from_memory(self, arg: Union[bytes, bytearray, memoryview], /) -> None: ...
    def read_from_stream(self, stream: Any) -> None:
    ...
    @overload
    def write_to_bytes(self, copy: Literal[True] = True, /) -> bytes: ...
    @overload
    def write_to_bytes(self, copy: Literal[False], /) -> memoryview: ...
    @overload
    def write_to_bytes(self, copy: bool = True, /) -> bytes | memoryview: ...
    def write_to_memoryview(self) -> memoryview: ...
    def write_to_stream(self, stream: Any) -> None:
    ...
    def assign_thumbnail(
        self, master_image: HeifImageHandle, thumbnail_image: HeifImageHandle
    ) -> None:
    ...
    def get_track(self, track_id: int = 0) -> HeifTrack:
        """Get a track object for track_id (0 for first visual track)."""
...
class HeifImageHandle:
    ...
    def get_depth_image_handle(self, depth_image_id: int) -> HeifImageHandle: ...
    def get_primary_depth_image_handle(self) -> HeifImageHandle: ...
    def get_depth_representation_info(
        self, depth_image_id: int = 0
    ) -> HeifDepthRepresentationInfo | None: ...
    @property
    ...
    def get_thumbnail(self, thumbnail_id: int, /) -> HeifImageHandle: ...
    @property
    def thumbnails(self) -> list[HeifImageHandle]: ...
    @property
...
class HeifImage:
    ...
    def crop(self, left: int, right: int, top: int, bottom: int) -> None:
...
class HeifDepthRepresentationInfo:
    has_z_near: bool
    has_z_far: bool
    has_d_min: bool
    has_d_max: bool
    ...
    d_min: float
    d_max: float
    depth_representation_type: int
    disparity_reference_view: int
...
class AsyncHeifImageHandle:
    ...
    def ambient_viewing_environment(
        self,
    ) -> Optional[HeifAmbientViewingEnvironment]: ...
    @property
    def color_profile_type(self) -> HeifColorProfileType: ...
    def get_raw_color_profile(self) -> bytes: ...
    ...
    async def get_auxiliary_image_handle_async(
        self, id: int
...
class AsyncHeifContext:
    ...
    async def __aenter__(self) -> AsyncHeifContext: ...
    async def __aexit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None: ...
    def __enter__(self) -> AsyncHeifContext: ...
    ...
    @overload
    async def write_to_bytes(self, copy: Literal[True] = True) -> bytes: ...
    @overload
    async def write_to_bytes(self, copy: Literal[False]) -> memoryview: ...
    @overload
    async def write_to_bytes(self, copy: bool = True) -> bytes | memoryview: ...
...
class HeifTrack:
    ...
    def encode_end_of_sequence(self, encoder: HeifEncoder) -> None: ...
...
def get_default_encoder_preset() -> str: ...
def set_default_encoder_preset(preset: str) -> None: ...
def get_libheif_version() -> str: ...
def get_libheif_version_number() -> int: ...
