...
def test_nclx_profile_roundtrip():
    ...
    assert nclx.color_primaries == pylibheif.HeifColorPrimaries.ITU_R_BT_2020_2_and_2100_0
    assert nclx.transfer_characteristics == pylibheif.HeifTransferCharacteristics.ITU_R_BT_2100_0_PQ
    assert nclx.matrix_coefficients == pylibheif.HeifMatrixCoefficients.ITU_R_BT_2020_2_non_constant_luminance
    ...
    assert nclx_get.color_primaries == pylibheif.HeifColorPrimaries.ITU_R_BT_2020_2_and_2100_0
    assert nclx_get.transfer_characteristics == pylibheif.HeifTransferCharacteristics.ITU_R_BT_2100_0_PQ
    assert nclx_get.matrix_coefficients == pylibheif.HeifMatrixCoefficients.ITU_R_BT_2020_2_non_constant_luminance
    ...
    assert nclx_handle.color_primaries == pylibheif.HeifColorPrimaries.ITU_R_BT_2020_2_and_2100_0
    assert nclx_handle.transfer_characteristics == pylibheif.HeifTransferCharacteristics.ITU_R_BT_2100_0_PQ
    assert nclx_handle.matrix_coefficients == pylibheif.HeifMatrixCoefficients.ITU_R_BT_2020_2_non_constant_luminance
    ...
    assert nclx_new.color_primaries == pylibheif.HeifColorPrimaries.ITU_R_BT_2020_2_and_2100_0
    assert nclx_new.transfer_characteristics == pylibheif.HeifTransferCharacteristics.ITU_R_BT_2100_0_PQ
    assert nclx_new.matrix_coefficients == pylibheif.HeifMatrixCoefficients.ITU_R_BT_2020_2_non_constant_luminance
...
async def test_async_color_profile():
    ...
    assert nclx_profile.transfer_characteristics == pylibheif.HeifTransferCharacteristics.ITU_R_BT_709_5
    assert nclx_profile.matrix_coefficients == pylibheif.HeifMatrixCoefficients.ITU_R_BT_709_5
